...
window.addEventListener('load', function () {
  ...
  var vs = createShader(vshaderSrc, gl.VERTEX_SHADER);
  var fs = createShader(fshaderSrc, gl.FRAGMENT_SHADER);
  ...
  var vertexPos = [0.0, 1.0, 1.0, 0.0, -1.0, 0.0];
