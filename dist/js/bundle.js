...
window.addEventListener('load', function () {
  ...
  var buffer = new Uint8Array(bufferWidth * bufferHeight),
      palletColors = new Uint8Array([0, 0, 0, 255, 0, 0, 255, 255, 0, 255, 0, 255, 0, 255, 255, 255, 255, 0, 0, 255, 255, 0, 255, 255, 255, 255, 0, 255, 255, 255, 255, 255]);
  ...
  function run() {
    var gen = regeneratorRuntime.mark(function _callee() {
      var i, y, ey, x, ex, _palletColors, r, g, b, a, _i, _y;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              for (i = 0, y = 0, ey = bufferHeight; y < ey; ++y) {
                for (x = 0, ex = bufferWidth; x < ex; ++x) {
            ...
            case 4:
              ...
              // パレットのスクロール
              _palletColors = _slicedToArray(palletColors, 4);
              r = _palletColors[0];
              g = _palletColors[1];
              b = _palletColors[2];
              a = _palletColors[3];
              ...
              for (_i = 0; _i < 7; ++_i) {
                palletColors[_i * 4] = palletColors[(_i + 1) * 4];
                palletColors[_i * 4 + 1] = palletColors[(_i + 1) * 4 + 1];
                palletColors[_i * 4 + 2] = palletColors[(_i + 1) * 4 + 2];
                palletColors[_i * 4 + 3] = palletColors[(_i + 1) * 4 + 3];
              }
              palletColors[28] = r;
              palletColors[29] = g;
              palletColors[30] = b;
