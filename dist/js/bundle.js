...
window.addEventListener('load', function () {
  ...
  // color 1 で塗りつぶす
  for (var i = 0, y = 0, ey = bufferHeight; y < ey; ++y) {
    for (var x = 0, ex = bufferWidth; x < ex; ++x) {
  ...
  function setAttribute(vbo, attL, attS) {
    for (var _i in vbo) {
      gl.bindBuffer(gl.ARRAY_BUFFER, vbo[_i]);
      gl.enableVertexAttribArray(attL[_i]);
      gl.vertexAttribPointer(attL[_i], attS[_i], gl.FLOAT, false, 0, 0);
    }
  }
  ...
  function run() {
    var gen = regeneratorRuntime.mark(function _callee() {
      var _palletColors, r, g, b, a, _i2, _y;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 1:
              ...
              for (_i2 = 0; _i2 < 7; ++_i2) {
                palletColors[_i2 * 4] = palletColors[(_i2 + 1) * 4];
                palletColors[_i2 * 4 + 1] = palletColors[(_i2 + 1) * 4 + 1];
                palletColors[_i2 * 4 + 2] = palletColors[(_i2 + 1) * 4 + 2];
                palletColors[_i2 * 4 + 3] = palletColors[(_i2 + 1) * 4 + 3];
              }
              palletColors[28] = r;
              palletColors[29] = g;
              palletColors[30] = b;
