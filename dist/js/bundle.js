...
window.addEventListener('load', function () {
  ...
  var vsF = createShader(vshaderFSrc, gl.VERTEX_SHADER);
  var fsF = createShader(fshaderFSrc, gl.FRAGMENT_SHADER);

  var prgF = createProgram(vsF, fsF);

  var prgFPos = gl.getAttribLocation(prgF, 'position');
  var prgFColor = gl.getAttribLocation(prgF, 'color');

  var attStride = 1;

  var vertexPos = [160.0, 100.0];

  var color = [7.0];

  var vbo = createVbo(vertexPos);
  var vboColor = createVbo(color);
